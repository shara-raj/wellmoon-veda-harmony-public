...
const WellnessInvitation = () => {
  return (
    <section className="py-20 lg:py-32 bg-gradient-warm relative overflow-hidden" style={{ backgroundImage: 'url(/images/pattern.png)', backgroundRepeat: 'repeat' }}>
      {/* Decorative elements */}
      ...
      <div className="container mx-auto px-4 lg:px-8 relative z-10">
        <div className="max-w-4xl mx-auto text-center space-y-8 animate-fade-in">
          <div className="space-y-6">
            ...
            <blockquote className="text-5xl lg:text-6xl font-bold text-foreground italic leading-relaxed" style={{ fontFamily: 'Tangerine, cursive' }}>
