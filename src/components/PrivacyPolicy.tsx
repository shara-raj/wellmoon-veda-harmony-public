    ...
    <>
      ...
      >
        <div className="container mx-auto px-4 lg:px-8 py-16">
          <h1 className="text-4xl md:text-5xl font-serif font-semibold text-foreground text-center text-middle mb-12">
            Privacy Policy
          </h1>
          ...
          <div className="prose prose-lg max-w-none space-y-8 text-muted-foreground">
            <section>
              <p className="font-['Quicksand',_'Poppins',_sans-serif] font-normal leading-relaxed text-lg">
                ...
                commitment, our privacy policy governs our actions regarding the
            ...
            <section>
              ...
              <p className="font-['Quicksand',_'Poppins',_sans-serif] font-normal leading-relaxed">
                ...
                or individuals who is/are responsible for compliance with our
                privacy policy.
              </p>
            </section>
            ...
            <section>
              ...
              <p className="font-['Quicksand',_'Poppins',_sans-serif] font-normal leading-relaxed">
                ...
                you with the product or service you have requested and to offer
                you additional products and services we believe you might be
            ...
            <section>
              ...
              <p className="font-['Quicksand',_'Poppins',_sans-serif] font-normal leading-relaxed">
                ...
                to the supply of a product or service, except as necessary to be
            ...
            <section>
              ...
              <p className="font-['Quicksand',_'Poppins',_sans-serif] font-normal leading-relaxed">
                ...
                which it is to be used. Upon request, you will be informed of
                the existence, use and disclosure of your Personal Information,
                and will be given access to it. You may verify the accuracy and
                completeness of your Personal Information and may request that
                it be amended, if appropriate.
              </p>
            </section>
            ...
            <section>
              ...
              <p className="font-['Quicksand',_'Poppins',_sans-serif] font-normal leading-relaxed">
                ...
                may be stored in your computer's hard drive when you visit our
                ...
                browser settings to prevent your computer from accepting
                cookies. Our website may also contain links to other third-party
                sites that are not governed by this privacy policy. We suggest
                that you examine the privacy statements of those sites.
              </p>
            </section>
